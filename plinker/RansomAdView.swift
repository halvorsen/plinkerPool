...
class RansomAdView: UIView, BrothersUIAutoLayout {
    ...
    init() {
        ...
        self.backgroundColor = UIColor(colorLiteralRed: 21/255, green: 20/255, blue: 60/255, alpha: 1.0)
        myImageView = UIImageView(frame: CGRect(x: 0, y: yOrigin, width: 375*sw, height: 667*sw))
        myImageView.image = #imageLiteral(resourceName: "RansomAd")
