...
class FiretailAdView: UIView, BrothersUIAutoLayout {
    ...
    init() {
        ...
        self.backgroundColor = UIColor(colorLiteralRed: 33/255, green: 33/255, blue: 33/255, alpha: 1.0)
        let myImageView = UIImageView(frame: CGRect(x: 0, y: yOrigin, width: 375*sw, height: 667*sw))
        myImageView.image = #imageLiteral(resourceName: "FiretailAd")
